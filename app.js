...
//cekkoneksi model - migration - proyek sequelize
...
app.use(methodOverride("_method")); //menggunakan _method put
app.use('/uploads', express.static('uploads')); //agar gambar yang disimpan di folder uploads dibolehkan untuk diambil/dimunculakn di browser (FE)
